...
// import ua_flag from '../images/ua.svg';
import './select.css';
  ...
  <div id="select-box">
    ...
    <SelectButton>
      ...
      <StyledChevrons id="chevrons">
        ...
        <Icon iconId='projects' iconClass="fas fa-chevron-up"/>
        <Icon iconId='projects' iconClass="fas fa-chevron-down"/>
      </StyledChevrons>
    </SelectButton>
    <Options id="options">
      {data.map(({value, iconClass}) => {
        return (
          <StyledOption className="option" key={value}>
            <input className="s-c top" type="radio" name="platform" value={value}/>
            <input className="s-c bottom" type="radio" name="platform" value={value}/>
